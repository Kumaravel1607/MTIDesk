...
List<Requestlist> requestListFromJson(String str) => List<Requestlist>.from(
    json.decode(str).map((x) => Requestlist.fromJson(x)));

String requestListToJson(List<Requestlist> data) =>
